...
<div id="sidebar" class="sidebar">
  <div class="sidebar-content">
    ...
    <div class="headerLinks">
      ...
      <a href="/reading-flow"><i class="fa-solid fa-bars-staggered"></i> Reading flow</a>
    </div>
    ...
    <div class="headerLinks">
      <a on:click={()=>{loading('reading')}} href="/bookshelf/reading"><i class="fa-solid fa-book-bookmark"></i> Reading</a>
      <a on:click={()=>{loading('to_read')}} href="/bookshelf/to_read"><i class="fa-regular fa-clock"></i> To read</a>
      <a on:click={()=>{loading('read')}} href="/bookshelf/read"><i class="fa-regular fa-check"></i> Already read</a>
      <a on:click={()=>{loading('favorites')}} href="/bookshelf/favorites"><i class="fa-regular fa-star"></i> Favourites</a>
      <a on:click={()=>{loading('untagged')}}  href="/bookshelf/untagged"><i class="fa-solid fa-tag"></i> Untagged</a>
    </div>
